...
from training.complete_notebook_cells import build_complete_notebook_cells
from training.notebook_generator import SUPPORTED_NOTEBOOK_MODES


class CompleteNotebookGenerator:
    def __init__(
        self,
        ...
        self.output_dir = output_dir or base_dir / "notebooks" / "complete" / "generated"
    ...
    def render(self, mode: str) -> str:
        ...
        rendered_notebook = template.render(
            cells=build_complete_notebook_cells(self.config, resolved_mode),
            metadata={
                "kernelspec": {
    ...
    def generate(self, mode: str) -> Path:
        ...
        output_path = self.output_dir / f"chronospectra_{resolved_mode}_complete.ipynb"
    ...
    def _validate_mode(self, mode: str) -> str:
        ...
        if resolved_mode not in SUPPORTED_NOTEBOOK_MODES:
            ...
            raise ValueError(
                f"Unsupported complete notebook mode '{mode}'. Expected: {supported_modes}."
            )
